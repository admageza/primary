...
class PerformersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performer" do
    assert_difference('Performer.count') do
      post performers_url, params: { performer: { body: @performer.body, image: @performer.image, title: @performer.title } }
    end
  ...
  test "should update performer" do
    patch performer_url(@performer), params: { performer: { body: @performer.body, image: @performer.image, title: @performer.title } }
