...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { body: @test.body, firstname: @test.firstname, lastname: @test.lastname } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { body: @test.body, firstname: @test.firstname, lastname: @test.lastname } }
